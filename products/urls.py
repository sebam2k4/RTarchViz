...
urlpatterns = [
    ...
    url(r'^(?P<slug>[-\w]+)--(?P<product_id>\d+)/?$', views.product_detail, name='product_detail'),
    url(r'^(?P<slug>[-\w]+)--(?P<product_id>\d+)/edit/$', views.edit_product, name='edit_product'),
    url(r'^(?P<slug>[-\w]+)--(?P<product_id>\d+)/delete/$', views.delete_product, name='delete_product'),
